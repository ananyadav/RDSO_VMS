...
class TestPlaybackRoutes(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_playback_search_success(self, mock_search):
    ...
    async def test_playback_search_missing_camera(self):
    ...
    async def test_playback_search_missing_date(self):
    ...
    async def test_playback_search_invalid_date(self):
        request = make_mocked_request(
    ...
    @patch("app.routes.playback.search_recordings_by_date", new_callable=AsyncMock)
    async def test_playback_search_camera_not_found(self, mock_search):
