...
import { X, Building2, Plus, Pencil, Trash2, Power, MapPin } from 'lucide-react';
...
export default function ManageLocationsModal({
  ...
  const deleteBuilding = async (siteId: string, buildingId: string, name: string) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-5 space-y-6">
          <section>
            <h4 className="text-sm font-semibold text-gray-500 uppercase mb-3">Site / Unit hierarchy</h4>
            {sites.length === 0 ? (
                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <div className="flex gap-1 shrink-0">
                              ...
                              <button
                                ...
                                onClick={() => void deleteBuilding(site.id, b.id, b.name)}
                                disabled={saving}
                              >
                                <Trash2 size={12} />
                              </button>
                            ...
                            {(b.floors || []).map((f) => (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  title="Delete"
                                  onClick={() => void deleteFloor(site.id, b.id, f.name)}
                                  disabled={saving}
                                >
                                  <Trash2 size={10} />
                                </button>
